...
const SimMaterial MATERIALS[MATERIAL_COUNT] = {//Material table
  ...
  //(density for gasses: 0 - 50, for liquid: 50 - 99, other: 100)
    ...
    { "Stone", STONE, STATIC_SOLID, STONE_COLOR, false, false, 25, 100, 0 },
    { "Steam", STEAM, GAS, SKYBLUE, false, false, 25, 20, 0 },
    { "WetSand", WET_SAND, DYNAMIC_SOLID, WET_SAND_COLOR, false, false, 25, 100, 0 },
    { "Smoke", SMOKE, GAS, SMOKE_COLOR, false, false, 25, 50, 0},
    ...
    { "Rainy Cloud", RAINY_CLOUD, GAS, RAINY_CLOUD_COLOR, false, false, 25, 15, 0},
